...
TELEGRAM_DANGEROUS_DELETE_REPLY = _fmt_sys(
    "Удаление данных через Telegram недоступно — и это осознанное ограничение. "
    "Необратимые операции требуют явного подтверждения, которое невозможно безопасно провести в формате чата.\n\n"
    "Ничего не было изменено или удалено. Все ваши данные на месте.\n\n"
    "Если хотите разобраться с задачами или архивом — скажите, что именно нужно сделать, "
